...
public class App {
	...
	public CommandLineRunner demo() {
		return (args) -> {
			...
			emp1.setFirstName("updated_first_name");
			emp1.setLastName("updated_last_name");

			employeeRepository.update(emp1);

			Employee temp = employeeRepository.get(emp1.getId());
			System.out.println("Updated Employee : " + temp);
		};
	}
