...
public class App {
	...
	public CommandLineRunner demo() {
		return (args) -> {
			...
			List<Object[]> empsToBeUpdated = new ArrayList<>();

			for (Employee emp : employeeRepository.all()) {
				Object[] obj = { emp.getFirstName().toUpperCase(), emp.getLastName().toUpperCase(), emp.getId() };
				empsToBeUpdated.add(obj);
			}

			employeeRepository.update(empsToBeUpdated);
