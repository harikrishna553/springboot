...
public class App {
	...
	public CommandLineRunner demo(EmployeeRepository employeeRepository) {
		return (args) -> {
			...
			emps = employeeRepository.findByFirstNameIgnoreCase("Ram");
			printEmployees(emps, "Employees with firstName 'Ram' ignore case");

			emps = employeeRepository.findByLastNameIgnoreCase("Battu");
			printEmployees(emps, "Employees with lastName 'Battu' ignore case");

			emps = employeeRepository.findByFirstNameContainingIgnoreCase("A");
			printEmployees(emps, "Employees with firstName contains 'A' ignore case");
