...
public class App {
	...
	public CommandLineRunner demo(EmployeeRepository employeeRepository) {
		return (args) -> {
			...
			Employee emp2 = Employee.builder().firstName("Joel").lastName("Chelli").age(32).salary(60000).build();
			...
			Employee emp7 = Employee.builder().firstName("Sushmithaa").lastName("Kulakarni").age(32).salary(100000.23)
					.build();
