...
public class App {
	...
	public CommandLineRunner demo(EmployeeRepository employeeRepository) {
		return (args) -> {
			...
			Employee emp9 = Employee.builder().firstName("Krishna").lastName("Zlam").age(33).salary(80000.23).build();
			...
			long empsDeleted = employeeRepository.removeByFirstName("Ram");
			System.out.println("Removing the records matched to firstName 'Ram'");
			System.out.println("Total records deleted : " + empsDeleted + "\n");

			empsDeleted = employeeRepository.deleteByLastName("Battu");
			System.out.println("Removing the records matched to lastName 'Battu'");
			System.out.println("Total records deleted : " + empsDeleted + "\n");

			List<Employee> deletedEmps = employeeRepository.deleteByFirstName("Surendra");
			System.out.println("Removing the records matched to firstName 'Surendra'");
			System.out.println("Total records deleted : " + deletedEmps.size() + "\n");

			deletedEmps = employeeRepository.removeByLastName("Ptr");
			System.out.println("Removing the records matched to lastName 'Ptr'");
			System.out.println("Total records deleted : " + deletedEmps.size() + "\n");
