...
import com.sample.app.itemprocessor.EmployeeUpperCaseProcessor;
...
public class JobConfiguration {
	...
	@Autowired
	private EmployeeUpperCaseProcessor upperCaseProcessor;
	...
	public Step step1() throws Exception {
		return this.stepBuilderFactory.get("step1").<Employee, Employee>chunk(5).reader(jdbcCursorItemReader())
				.processor(upperCaseProcessor).writer(jsonFileItemWriter()).build();
	}
