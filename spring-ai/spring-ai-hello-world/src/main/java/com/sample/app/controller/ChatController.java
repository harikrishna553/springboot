...
public class ChatController {
	...
	@GetMapping
	@Operation(summary = "Send a chat message", description = "Send a message to the AI and get a response")
	...
	@PostMapping
	@Operation(summary = "Send a chat message via POST", description = "Send a message to the AI via POST request")
