...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public AuthenticationManager authenticationManager() {
		return new ProviderManager(Arrays.asList(bearerAuthProvider));
	};

	@Bean
	public BearerTokenFilter authenticationTokenFilterBean() {
		BearerTokenFilter authenticationFilter = new BearerTokenFilter(PROTECTED_URLS);
